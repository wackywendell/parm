...
neighborlist* neighborlistL(shared_ptr<Box> box, const double innerradius, const double outerradius){
...
ContactTracker* ContactTrackerD(shared_ptr<Box> box, shared_ptr<atomgroup> atoms, vector<double> dists){
