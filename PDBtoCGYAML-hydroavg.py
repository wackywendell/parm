...
Hnames, Hcoeffs = zip(*sorted(hydroavg.items()))
Hcoefflists = [[round((H1 + H2)/2 * chargek/radius, 5) for H1 in Hcoeffs] for H2 in Hcoeffs]
...
for res in residues:
    ...
    atomdict['mass'] = m = round(masses[name] - BBmass, 5)
