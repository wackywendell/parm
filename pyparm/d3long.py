...
class dihedral(_object):
    ...
    def forces(self, diff1: 'Vec const &', diff2: 'Vec const &', diff3: 'Vec const &') -> "array< Vec,4 >":
        """forces(dihedral self, Vec const & diff1, Vec const & diff2, Vec const & diff3) -> array< Vec,4 >"""
